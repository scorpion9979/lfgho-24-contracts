...
/// @dev Forked from
/// https://github.com/hifi-finance/hifi/blob/main/packages/protocol/contracts/oracles/IChainlinkOperator.sol
interface IChainlinkOperator {
    ...
    function getFeed(string memory symbol) external view returns (IERC20, IAggregatorV3, bool);
